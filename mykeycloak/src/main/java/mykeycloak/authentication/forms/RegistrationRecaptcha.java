...
public class RegistrationRecaptcha implements FormAction, FormActionFactory, ConfiguredProvider {
    ...
    public static final String PROVIDER_ID = "my-registration-recaptcha-action";
    ...
    public String getHelpText() {
        return "new ... Adds Google Recaptcha button.  Recaptchas verify that the entity that is registering is a human.  This can only be used on the internet and must be configured after you add it.";
    }
